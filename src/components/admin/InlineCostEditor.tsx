  ...
  if (!editing) {
    return (
      <button
        ...
        onClick={start}
        title="Click to edit"
        className="flex items-center gap-1.5 rounded-full border border-sand-200 bg-surface px-2.5 py-1 text-xs font-medium text-ocean-950/70 hover:border-ocean-300 hover:text-ocean-700"
      >
